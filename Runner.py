...
class Runner(object):
    ...
    header_font = ImageFont.truetype("abel-regular.ttf", 40)
    font = ImageFont.truetype("abel-regular.ttf", 25)
    ...
    def write_on_header(self, header_img, parameters):
        ...
        if not parameters['success']:
            ...
            line3, line4 = '', ''
        draw.text((230, 35), line0, (0,0,0), font=self.header_font)
        draw.text((220, 160), line1+line2+line3+line4, (0,0,0), font=self.font)
    ...
    def generate_movie(self, filename):
        ...
        writer = cv2.VideoWriter(filename, cv2.VideoWriter_fourcc(*"XVID"), 20.0, (width//2,height//2))
